        ...
        <div class="clever-main-menu">
          <div class="classy-nav-container breakpoint-off">
            <nav class="classy-navbar justify-content-between" id="cleverNav">
              <a class="nav-brand hidden-sm-only" href="/">微</a>
                ...
                <div class="classynav">
                  ...
                  <el-menu :default-active="activeIndex"
                    ...
                    <el-submenu index="/u">
                      ...
                      <el-menu-item index="u-source" @click="open('url')">
                        源码地址
                      </el-menu-item>
                      <el-menu-item index="u-deploy" @click="open('url')">
                        部署文档
                      </el-menu-item>
                      <el-menu-item index="c-log" @click="open('url')">
                        更新日志
                      </el-menu-item>
                      <el-menu-item index="c-overview"  @click="open('url')">
                        规划总览
                      </el-menu-item>
                      <el-menu-item index="u-admin" @click="open('http://localhost:81')">
                        管理后台
                      </el-menu-item>
                    </el-submenu>
