    ...
    <div class="container">
      <div class="site-info">
        <el-row>
          <el-col :span="3" :offset="2" class="footer-col">
            ...
            <a target="_blank" href="http://localhost:81">管理后台</a>
          </el-col>
      ...
      <el-row :gutter="20" style="margin-top: 50px;">
        <el-col :span="12" :offset="8">
          <div class="copyright">
            <h4 class="content-c2" style="text-align: center;">Copyright ©2019</h4>
            <ul class="privacy">
              ...
              <li class="content-c1"><a class="content-c0" target="_blank" href="https://github.com/359995148/exam.git">开发者中心</a></li>
            </ul>
          </div>
        </el-col>
      </el-row>
      <el-row :gutter="20">
        <el-col :span="12" :offset="6">
          <div class="cop">
            <a class="content-c3" href="https://github.com/359995148/exam.git" target="_blank">
            </a>
          </div>
        </el-col>
      </el-row>
