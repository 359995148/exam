package com.github.fanzh.common.core.utils.excel;
...
import com.github.fanzh.common.core.utils.excel.annotation.ExcelModel;
import com.github.fanzh.common.core.utils.excel.exception.ExcelException;
...
public class ExcelToolUtil {
    ...
    public static <T> void exportExcel(
        ...
        // 导出
        exportExcel(request, response, dataList, fileName, sheetName, clazz);
    }
     ...
     * @return boolean
     */
    public static <T> Boolean importExcel(MultipartFile multipartFile, Class<T> clazz, AnalysisEventListener<T> listener) {
        try {
            return importExcel(multipartFile.getInputStream(), clazz, listener);
        } catch (Exception e) {
     ...
     * @return boolean
     */
    public static <T> Boolean importExcel(InputStream inputStream, Class<T> clazz, AnalysisEventListener<T> listener) {
