package com.github.fanzh.gateway.handler;

import com.github.fanzh.common.core.constant.ApiMsg;
import com.github.fanzh.common.core.entity.ExecResult;
import com.github.fanzh.common.core.exceptions.InvalidAccessTokenException;
import com.github.fanzh.common.core.exceptions.InvalidValidateCodeException;
import com.github.fanzh.common.core.exceptions.ValidateCodeExpiredException;
import com.github.fanzh.common.core.utils.Assert;
...
public class GatewayExceptionHandler implements ErrorWebExceptionHandler {
     ...
     * 存储处理异常后的信息
     */
    private ThreadLocal<ExecResult<?>> exceptionHandlerResult = new ThreadLocal<>();
    ...
    public Mono<Void> handle(ServerWebExchange exchange, Throwable ex) {
        ...
        // 封装响应体
        ExecResult<String> execResult = new ExecResult<>(msg, keyCode, msgCode);
        // 错误记录
        ServerHttpRequest request = exchange.getRequest();
        log.error("GatewayExceptionHandler: {}, error: {}", request.getPath(), ex.getMessage());
        if (exchange.getResponse().isCommitted())
            return Mono.error(ex);
        exceptionHandlerResult.set(execResult);
    ...
    private Mono<ServerResponse> renderErrorResponse(ServerRequest request) {
        ExecResult<?> execResult = exceptionHandlerResult.get();
        return ServerResponse.status(HttpStatus.OK)
                .contentType(MediaType.APPLICATION_JSON_UTF8)
                .body(BodyInserters.fromObject(execResult));
    }
