package com.github.fanzh.user.api.feign;
...
import com.github.fanzh.user.api.feign.factory.UserServiceClientFallbackFactory;
...
public interface UserServiceClient {
    ...
    ExecResult<UserVo> findUserByIdentifier(@PathVariable("identifier") String identifier, @RequestParam("tenantCode") String tenantCode);
     ...
     */
    @GetMapping("/v1/user/anonymousUser/findUserByIdentifier/{identifier}")
    ExecResult<UserVo> findUserByIdentifier(@PathVariable("identifier") String identifier, @RequestParam(value = "identityType", required = false) Integer identityType, @RequestParam("tenantCode") String tenantCode);
    ...
    ExecResult<List<UserVo>> findUserById(@RequestBody List<Long> ids);
    ...
    ExecResult<Integer> findUserCount(@RequestBody UserVo userVo);
    ...
    ExecResult<List<DeptVo>> findDeptById(@RequestBody List<Long> ids);
    ...
    ExecResult<Boolean> deleteAttachment(@RequestBody List<Long> id);
    ...
    ExecResult<List<AttachmentVo>> findAttachmentById(@RequestBody List<Long> ids);
     ...
     */
    @PostMapping("/v1/log")
    ExecResult<Boolean> saveLog(@RequestBody Log log);
    ...
    ExecResult<List<Menu>> findMenuByRole(@PathVariable("role") String role, @RequestParam("tenantCode") String tenantCode);
    ...
    ExecResult<List<Menu>> findAllMenu(@RequestParam("tenantCode") String tenantCode);
    ...
    ExecResult<Tenant> findTenantByTenantCode(@PathVariable("tenantCode") String tenantCode);
    ...
    ExecResult<UserVo> findUserBySocial(@PathVariable("social") String social, @RequestParam("tenantCode") String tenantCode);
    ...
    ExecResult<Boolean> registerUser(@RequestBody UserDto userDto);
    ...
    ExecResult<Boolean> updateLoginInfo(UserDto userDto);
}
