package com.github.fanzh.user.enums;
...
public enum AttachUploaderEnum {
    ...
    FILE(1, "文件", "com.github.fanzh.user.uploader.FileUploader"),
    FAST_DFS(2, "FastDfs", "com.github.fanzh.user.uploader.FastDfsUploader"),
    QI_NIU(3, "七牛云", "com.github.fanzh.user.uploader.QiNiuUploader"),
